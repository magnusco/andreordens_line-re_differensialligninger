...
Selv om vi tilsynelatende har jobbet med andreordens differensialligninger i dette kapitlet har teorien en ekvivalent formulering som systemer av føsteordens ligninger. Ved å innføre de nye variablene
\begin{equation*}
...
\section*{Oppgaver \footnote{Flere av oppgavene er hentet fra boken Tom Linstrøm: \textit{Kalkulus}. (2006, 3. utgave).}}

\paragraph*{1.} Finn den generelle løsningen til ligningene
\begin{multicols*}{2}
  \begin{itemize}
    ...
    \item[(f)] $\ddot{y} - \dot{y} + \frac{y}{4} = 0$  
  \end{itemize}
\end{multicols*}

\paragraph*{2.} Finn løsningen til initialverdiproblemene
\begin{itemize}
...
\begin{itemize}
  ...
  \begin{equation*}
    \ddot{y} - \dot{y} - 2y = 0.
  \end{equation*}
  \item[(b)] Finn en partikulærløsning til $\ddot{y} - \dot{y} - 2y = e^t$.
  \item[(c)] Finn en løsning til $\ddot{y} - \dot{y} - 2y = e^t$ slik at $y(0) = \dot{y}(0) = 2$.
\end{itemize}

\paragraph*{4.} Finn den generelle løsningen til ligningene
\begin{itemize}
  ...
  \item[(f)] $\ddot{y} + 2\dot{y} + y = 2t \sin(t)$ 
\end{itemize}

\paragraph*{5.}
\begin{itemize}
  \item[(a)] Finn den generelle løsningen til
  \begin{equation*}
    \ddot{y} + y = 0.
  \end{equation*}
  \item[(b)] Finn en partikulærløsning til ligningen $\ddot{y} + y = \tan(t)$.
  \item[(c)] Finn en løsning til $\ddot{y} + y = \tan(t)$ slik at **initialverdier**.
\end{itemize}

\paragraph*{6.} Finn den generelle løsningen til ligningene
\begin{itemize}
  \item[(a)] $\ddot{y} - 4\dot{y} + 4y = t^2 e^t$
  \item[(a)] $\ddot{y} - 2\dot{y} + y = e^t \sin(t)$
\end{itemize}
...
\paragraph*{1.} Ved å regne ut røttene til det karakteristike polynomet til ligningene finner man
\begin{itemize}
  \item[(a)] $\ddot{y} + \dot{y} - 6 y = 0$
  \item[(b)] $\ddot{y} + 5\dot{y} + 4y = 0$
  \item[(c)] $\ddot{y} + 6\dot{y} + 9y = 0$
